...
//          if (!BME280) {
//            Firmata.sendString("Could not find a valid BME280 sensor, check wiring!");
//            while (1);
//          }
          delay(100);
          ...
          String Pressure = String(String(bme.readPressure() / 100.0F).toInt()*100);
          int Altitude = bme.readAltitude(SEALEVELPRESSURE_HPA)*100;
          int Humidity = bme.readHumidity()*100;
          strData = String(Temperature)+String(Humidity)+String(Altitude)+Pressure;
